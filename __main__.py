...
inverted_index = populate_inverted_index_dict_with_word_as_key('./all-places-strings.lc.txt')
...
for file in files:
    ...
    inverted_index = populate_inverted_index_dict_with_newid_as_values(newid_dict, inverted_index)
